...
/**
 * Custom Qualcomm RIL for LS740
 *
 * {@hide}
 */
public class LS740RIL extends LgeLteRIL implements CommandsInterface {
    static final String LOG_TAG = "LS740RIL";

    public LS740RIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        super(context, preferredNetworkType, cdmaSubscription, instanceId);
    }

    public LS740RIL(Context context, int networkMode, int cdmaSubscription) {
